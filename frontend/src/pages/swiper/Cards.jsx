  ...
  return (
    <div className='container row justify-content-center align-items-center rootSwipe'>
      ...
      <div className="buttonSwipe col-md-10 justify-content-center">
        ...
        <button type="button" className="btn btn-danger rounded-circle buttonOfSwipe" onClick={() => showMessage('left')}>
        ...
        <button type="button" className="btn btn-success rounded-circle buttonOfSwipe" onClick={() => showMessage('right')}>
